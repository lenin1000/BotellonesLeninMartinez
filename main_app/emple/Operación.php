...
<div class="container">
    ...
    <form action="" method="post" class="row g-3 needs-validation" novalidate>
        <div class="col-md-4 mb-4">
            <input type="hidden" name="action3" id="action3" value="Insertar">
    ...
    <div class="row mt-4">
        <div class="col-12">
            ...
            <button class="btn btn-primary" onclick="location.href='../AñadirClienteEM.php'" type="button">Añadir Cliente</button>
